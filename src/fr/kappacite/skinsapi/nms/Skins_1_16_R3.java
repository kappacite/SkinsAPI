...
public class Skins_1_16_R3 extends Skins {
    ...
    protected void updateSkin(Player player, boolean updateSelf) {
        ...
        PacketPlayOutRespawn respawnEntityPacket = new PacketPlayOutRespawn (
                entityPlayer.getWorld().getDimensionManager(), world.getDimensionKey(),
                Hashing.sha256().hashLong(craftPlayer.getWorld().getSeed()).asLong(), entityPlayer.playerInteractManager.getGameMode(), entityPlayer.playerInteractManager.getGameMode(), false, false, true);
